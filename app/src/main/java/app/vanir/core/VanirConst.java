...
public final class VanirConst {
    ...
    public static boolean F_SETOWN(int mode) { return (mode & S_IFMT) == F_SETOWN; }
    ...
    public static String vanName(int error) {
        if (error == EAI_AGAIN) {
            return "EAI_AGAIN";
        }
    ...
    private static native void valueConst();

    private static native void initConst();
